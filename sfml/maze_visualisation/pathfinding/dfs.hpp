...
class DFS : public PathfindingVisualsation
{
private:
...
private:
    std::stack<std::shared_ptr<Node>> m_open;
...
public:
	...
	DFS(const std::vector<std::vector<int>>& grid, std::array<int, 2> start, std::array<int, 2> end)
